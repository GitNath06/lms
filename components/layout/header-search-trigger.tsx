  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={open}
        className="hidden md:flex items-center justify-between w-full max-w-md gap-2.5 px-3 py-1.5 rounded-xl border border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-100/60 dark:bg-zinc-900/60 hover:bg-white dark:hover:bg-zinc-850 hover:border-indigo-400/60 dark:hover:border-indigo-600/60 shadow-2xs text-xs font-sans transition-all cursor-pointer group text-left select-none"
